...
import BlynkLib  # Blynk library for sending data to Blynk

# Blynk Setup
BLYNK_AUTH_TOKEN = 'FsyiTaR2lTdx8686bwyu0ExoThcjdnfD'  # Replace with your Blynk Auth Token
...
text = "Air Quality is 400 PPM Don't Step Out of House"
